...
└── services [job-portal-service]         → Business microservices
    ...
    ├── job-portal-company-service        → Company profiles & management (in progress)
...
| `job-portal-company-service` | Company profiles & management | 🟡 In progress (entity, DTOs & repository done; service logic & controller pending) |
